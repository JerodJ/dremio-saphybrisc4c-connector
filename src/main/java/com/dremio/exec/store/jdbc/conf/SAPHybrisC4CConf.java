...
@SourceType(value = "SAPHybrisC4CARP", label = "SAPHybrisC4C",uiConfig = "saphybrisc4c-layout.json")
public class SAPHybrisC4CConf extends AbstractArpConf<SAPHybrisC4CConf> {
  private static final String ARP_FILENAME = "arp/implementation/saphybrisc4c-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.saphybrisc4c.SAPHybrisC4CDriver";
